...
if (!isset($_SESSION['downloads_inserida'])) {
    ...
    if (mysqli_stmt_num_rows($stmt) == 0) {
        ...
        $tags = ['downloads', 'downloads da azul turquesa', 'baixar musicas da azul turquesa', 'baixar', 'albuns', 'musicas', 'mp3'];
...
<body>
    ...
    <?php 
    $titulo = "Downloads";
    $descricao = "Aqui fica disponível para Download gratuito alguns trabalhos da Azul Turquesa em boa qualidade para todos curtirem.";
    $imagem = "../assets/img/materias/downloads/Pusilanime-Azul-Turquesa.jpg"; // A URL de uma imagem de destaque
    $url = "http://localhost/azulTurquesa_website/app/downloads.php"; // A URL da página atual
    ...
    <main>
        ...
        <div class="music-container">
            ...
            <img src="../assets/img/materias/downloads/cid-10-f19-5.jpg" alt="Azul Turquesa CID 10 F19.5 2023" width="300" height="auto">
            <br><br>
        ...
        <form action="comentarios.php" method="POST">
            ...
            <input type="hidden" name="pagina_id" value="300"> <!-- Substitua value pelo ID da página atual -->
        ...
        <?php
            ...
            $pagina_id = 300; // Substitua pelo ID da página desejada
